...
* June 2016
  ...
  * [ ] [Issue 923](../issues/923): Setup: warn user if they disable full packet capture
  * [ ] [Issue 932](../issues/932): Setup: consistently apply title to all zenity windows
  * [ ] [Issue 871](../issues/871): CapMe: add session support to avoid re-authenticating every time
  * [ ] [Issue 930](../issues/930): CapMe: increase memory limit
  * [ ] [Issue 933](../issues/933): CapMe: handle inactive/failed pcap_agents more gracefully
  * [ ] [Issue 867](../issues/867): Squert: handle large pcap transcripts more gracefully
  * [ ] [Issue 929](../issues/929): Squert: update mysql call in scripts
  * [ ] [Issue 931](../issues/931): nsm_sensor_backup-data missing leading slash in directory
  ...
  * [ ] [Issue 927](../issues/927): CapMe: Handle 0-byte connections more gracefully
