...
* March 2016
  ...
  * [x] [Issue 735](../issues/735): Setup: Production Mode should automatically configure PF_RING instances based on number of CPU cores
  * [x] [Issue 874](../issues/874): Setup: add -w option to write out sosetup.conf file
  * [ ] [Issue 876](../issues/876): Setup: division by 0 error on SNIFFING_INTERFACES if master server (no sniffing)
  * [ ] [Issue 866](../issues/866): NSM: Squert object_mappings table has wrong permissions
