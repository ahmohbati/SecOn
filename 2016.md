...
* July 2016
  ...
  * [ ] [Issue 960](../issues/960): sostat: output when current monitoring interval has not completed
  ...
  * [ ] [Issue 304](../issues/304): Setup: support unique interface names
  * [ ] [Issue 944](../issues/944): NSM: backup scripts should not prompt when run with --force-yes
  * [ ] [Issue 561](../issues/561): NSM: nsm\_server\_backup-config should check FORCE\_YES
...
* September 2016
  ...
  * [ ] [Issue 654](../issues/654): NSM: disable SNORT\_PERF\_STATS in snort\_agent.conf when ENGINE=suricata
