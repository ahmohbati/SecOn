...
* September 2016
  ...
  * [ ] [Issue 985](../issues/985): rule-update should always log to /var/log/nsm/pulledpork.log
  * [ ] [Issue 990](../issues/990): sostat: Fix redirect to file issue
  * [ ] [Issue 991](../issues/991): sostat: Remove redundant source call
  * [ ] [Issue 992](../issues/992): sostat: Enable nullglobs to prevent string literal bug in various for loops
  * [ ] [Issue 996](../issues/996): sostat: report OS version and sostat version
  * [ ] [Issue 998](../issues/998): sostat: only show last run of rule-update
  * [ ] [Issue 961](../issues/961): soup: remove any autoremove recommendations
  * [ ] [Issue 962](../issues/962): soup: recommend upgrading to 16.04 HWE stack
  * [ ] [Issue 993](../issues/993): NSM: start/restart errors on systems with ethXX (2 or more numbers)
  * [ ] [Issue 1005](../issues/1005): NSM: redirect iostreams to logfile during ossec-agent restart

* October 2016
  * [ ] [Issue 1001](../issues/1001): securityonion-web-page: move Top/Bottom links to beginning of line
  * [ ] [Issue 1002](../issues/1002): securityonion-web-page: fix ELSA FIREWALL_ACCESS_DENY queries
  * [ ] [Issue 1004](../issues/1004): securityonion-web-page: standardize Autoruns queries
  * [ ] [Issue 988](../issues/988): Setup: use lowercase of hostname when creating sensornames
  * [ ] [Issue 989](../issues/989): Setup: postinst should check for existence of account before chown
  * [ ] [Issue 999](../issues/999): Setup: reduce the number of RSS queues to 1 on sniffing interfaces
  * [ ] [Issue 1000](../issues/1000): Setup: rename VRT to Talos
  ...
  * [ ] [Issue 958](../issues/958): Squert: OSSEC HIDS alerts display NIDS rules
