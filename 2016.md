...
* August 2016
  * [ ] [Issue 966](../issues/966): Setup: sosetup.conf needs to include MTU
  * [ ] [Issue 592](../issues/592): sosetup: add -y option
  * [ ] [Issue 967](../issues/967): Squert: Parameter not escaped in ip2c.php
  * [ ] [Issue 969](../issues/969): Squert: prevent directory listing for subdirectories
  * [ ] [Issue 968](../issues/968): NSM: wipe stats.log when restarting Suricata
  ...
  * [ ] [Issue 970](../issues/970): securityonion-web-page: add queries for autoruns, dnp3, and modbus
  * [ ] [Issue 973](../issues/973): securityonion-web-page: Apache ServerName localhost
  * [ ] [Issue 964](../issues/964): securityonion-web-page: add "bottom" queries for long tail analysis
  * [ ] [Issue 971](../issues/971): securityonion-sguil-db-purge: add command line options
  * [ ] [Issue 972](../issues/972): securityonion-sguil-db-purge: update mysql calls
  * [ ] [Issue 974](../issues/974): securityonion-sguil-db-purge: check for privileges
