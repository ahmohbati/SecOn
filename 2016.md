...
* February 2016
  ...
  * [ ] [Issue 859](../issues/859): NSM: mkdir -p /var/run/nsm/ before trying to chown
  * [ ] [Issue 849](../issues/849): sostat: check timezone and warn if not UTC
  * [ ] [Issue 858](../issues/858): sostat: check default_start_time_offset
  * [ ] [Issue 865](../issues/865): Setup: only open port 22 in ufw firewall
  * [ ] [Issue 860](../issues/860): Setup: disable SURICATA events
