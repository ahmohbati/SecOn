...
* August 2016
  ...
  * [ ] [Issue 983](../issues/983): securityonion-elsa-extras: add "AR-LOG" header to autoruns pattern
  * [ ] [Issue 975](../issues/975): NSM: configure Snort snaplen via command line argument
  * [ ] [Issue 981](../issues/981): sosetup-network: bug when configuring management interface only
  * [ ] [Issue 984](../issues/984): securityonion-web-page: add HTTP top status code
