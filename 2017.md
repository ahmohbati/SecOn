...
* January 2017
  ...
  * [ ] [Issue 1066](../issues/1066): Squert: error when removing comment
  * [ ] [Issue 1067](../issues/1067): Squert: ip2c avoid hard loop when file unavailable

* February 2017
  * [ ] [Issue 880](../issues/880): 14.04.5.2 ISO image
  * [ ] [Issue 863](../issues/863): Xplico 1.2.0
